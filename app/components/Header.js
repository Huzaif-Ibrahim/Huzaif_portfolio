        ...
        <div className='z-1'>
          ...
          <div className='flex items-center justify-center gap-2 lg:gap-4 mt-6'>
            ...
            <motion.a
              ...
              href='/Huzaif Ibrahim.pdf' download className={`cursor-pointer flex items-center gap-2 rounded-full px-3 py-1 lg:px-6 lg:py-3 transition-all duration-700 border border-zinc-400 bg-white text-black`}><p className=''>my resume</p> <Image alt='' src={assets.download_icon} className='w-4' /></motion.a>
          </div>
        </div>
      </motion.div>
    </>
